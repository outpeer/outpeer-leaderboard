...
# Constants
COURSES = ["DS", "DA", "PE", "AI", "DS", "DA"]
COURSE_LABELS = {
    "DS": "Data Science",
    "DA": "Data Analytics",
    "PE": "Python Engineering",
    "AI": "AI Engineering",
    "DS": "Data Science Oct24"
    "DA": "Data Analytics Oct24"
}
...
def pull_data(data_type: str, fetching_date: str):
    ...
    return {
        course: (
            ...
            else conn.read(worksheet=f"{data_type} {course} Oct24", dtype=dtype_spec)
...
def display_attendance_chart(attendance_df, student_id):
    ...
    passed_lessons = int(attendance_df.loc[attendance_df["ИИН"] == student_id, "Кол-во пройденных занятий"].iloc[0])
